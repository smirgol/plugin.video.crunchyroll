...
class API:
    ...
    CRUNCHYROLL_UA_DEVICE = "Crunchyroll/ANDROIDTV/3.66.1_22349 (Android 14; en-US; Chromecast)"  # For device auth
    ...
    AUTHORIZATION_DEVICE = "Basic bWMyNDBjZTc1dzduYmRoYmIwcTY6RWN5c2JiV2RYbzFSMFdXQ1RFNTVEUGxabndXNC1PNWI="  # AndroidTV for device auth
